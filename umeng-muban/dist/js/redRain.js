...
RedRain.prototype = {
    ...
    setWaitTime: function setWaitTime() {
        /*设置等待时间3秒*/
        var _this = this;
        this.waitTime = 3;
    ...
    showPrize: function showPrize() {
        ...
        if (_this.resData['adms']) {
            ...
            $('.prizes-zoom-box').unbind("click").on('click', function () {
...
//# sourceMappingURL=redRain.js.map
